...
def detect_video(yolo, video_path):
    ...
    #out = cv2.VideoWriter('test_python_yolo3.avi',fourcc, 30.0, (1280,720))
    out = cv2.VideoWriter('test_python_yolo3.avi',fourcc, 30.0, (960,540))
...
def detect_video(yolo, video_path):
    ...
    #out = cv2.VideoWriter('test_python_yolo3.avi',fourcc, 30.0, (1920,1080))
    out = cv2.VideoWriter('test_python_yolo3.avi',fourcc, 30.0, (960,540))
    #out = cv2.VideoWriter('test_python_yolo3_resize.avi',fourcc, 30.0, (540,260))
    i = 0
